...
GLORAPI GLORError   glorCreateMesh(GLORMesh *mesh, unsigned int n, const double *vertices, const double *normals, const double *colors);
GLORAPI void        glorDrawMesh(GLORMesh mesh, unsigned int n, const double *positions, const double *directions, const double *ups, const double *colors, const double *scales);
GLORAPI void        glorDeleteMesh(GLORMesh mesh);
GLORAPI void        glorCameraLookAt(double camera_x, double camera_y, double camera_z, double center_x, double center_y, double center_z, double up_x,  double up_y,  double up_z);
