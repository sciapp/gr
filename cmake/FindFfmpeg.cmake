...
if(NOT FFMPEG_LIBRARY_OPENH264)
    find_library(FFMPEG_LIBRARY_OPENH264 NAMES ${GR_THIRDPARTY_LIBRARY_PREFIX}openh264${GR_THIRDPARTY_LIBRARY_SUFFIX} openh264)
endif()
...
if(FFMPEG_INCLUDE_DIR AND FFMPEG_LIBRARY_AVCODEC AND FFMPEG_LIBRARY_AVFORMAT AND FFMPEG_LIBRARY_AVUTIL AND FFMPEG_LIBRARY_SWSCALE)
    set(FFMPEG_LIBRARIES "${FFMPEG_LIBRARY_AVFORMAT};${FFMPEG_LIBRARY_AVCODEC};${FFMPEG_LIBRARY_SWSCALE};${FFMPEG_LIBRARY_AVUTIL};m;pthread")
    if(APPLE)
        list(APPEND FFMPEG_LIBRARIES "-framework VideoToolbox;-framework CoreVideo;-framework CoreFoundation;-framework CoreServices;-framework CoreMedia")
    endif()
    try_compile(FFMPEG_TEST_COMPILED ${CMAKE_CURRENT_BINARY_DIR}/ffmpeg_test ${CMAKE_CURRENT_LIST_DIR}/ffmpeg_test.cxx
            CMAKE_FLAGS "-DINCLUDE_DIRECTORIES=${FFMPEG_INCLUDE_DIR}"
            LINK_LIBRARIES ${FFMPEG_LIBRARIES})

    if(NOT FFMPEG_TEST_COMPILED AND FFMPEG_LIBRARY_THEORA AND FFMPEG_LIBRARY_OGG AND FFMPEG_LIBRARY_VPX AND FFMPEG_LIBRARY_OPENH264)
        list(APPEND FFMPEG_LIBRARIES "${FFMPEG_LIBRARY_THEORA};${FFMPEG_LIBRARY_OGG};${FFMPEG_LIBRARY_VPX};${FFMPEG_LIBRARY_OPENH264}")
        try_compile(FFMPEG_TEST_COMPILED ${CMAKE_CURRENT_BINARY_DIR}/ffmpeg_test ${CMAKE_CURRENT_LIST_DIR}/ffmpeg_test.cxx
                CMAKE_FLAGS "-DINCLUDE_DIRECTORIES=${FFMPEG_INCLUDE_DIR}"
                LINK_LIBRARIES ${FFMPEG_LIBRARIES})
    endif()
...
find_package_handle_standard_args(Ffmpeg
        ...
        REQUIRED_VARS FFMPEG_TEST_COMPILED FFMPEG_LIBRARY_AVFORMAT FFMPEG_LIBRARY_AVCODEC FFMPEG_LIBRARY_SWSCALE FFMPEG_LIBRARY_AVUTIL)
...
mark_as_advanced(FFMPEG_INCLUDE_DIR FFMPEG_LIBRARY_AVFORMAT FFMPEG_LIBRARY_AVCODEC FFMPEG_LIBRARY_SWSCALE FFMPEG_LIBRARY_AVUTIL FFMPEG_LIBRARY_THEORA FFMPEG_LIBRARY_OGG FFMPEG_LIBRARY_VPX FFMPEG_LIBRARY_OPENH264)
