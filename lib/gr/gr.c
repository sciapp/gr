...
static
void nop_axeslbl(int i, const char* lbl)
{
	return;
}
...
void gr_axeslbl(float x_tick, float y_tick, float x_org, float y_org,
                ...
                void (*fpx)(int, const char*), void (*fpy)(int, const char*))
{
  int errind, tnr;
  ...
  int decade, exponent, i, idx_x, idx_y;
  char string[256];
