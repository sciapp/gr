...
typedef enum {
  ...
  COLORMAP_BROWNSCALE, COLORMAP_BONE, COLORMAP_SPECTRAL,
...
double spectral[72][3] = {
  ...
  { 0.        , 0.53992113, 0.8667     },
  { 0.        , 0.57371549, 0.8667     },
  { 0.        , 0.60375775, 0.85543239 },
  { 0.        , 0.62066761, 0.80472817 },
  { 0.        , 0.63757746, 0.75402394 },
  { 0.        , 0.65448732, 0.70331972 },
  { 0.        , 0.6667    , 0.65730563 },
  { 0.        , 0.6667    , 0.62348592 },
  { 0.        , 0.6667    , 0.5896662  },
  { 0.        , 0.6667    , 0.55584648 },
  { 0.        , 0.66106338, 0.48823239 },
  { 0.        , 0.64415352, 0.35302958 },
  { 0.        , 0.62724366, 0.21782676 },
  { 0.        , 0.6103338 , 0.08262394 },
  { 0.        , 0.61314225, 0.         },
  { 0.        , 0.64693662, 0.         },
  { 0.        , 0.68073099, 0.         },
  { 0.        , 0.71452535, 0.         },
  ...
  { 0.47509577, 1.        , 0.         },
  { 0.66100282, 1.        , 0.         },
  { 0.76428592, 0.9896662 , 0.         },
  { 0.81499014, 0.97275634, 0.         },
  { 0.86569437, 0.95584648, 0.         },
  { 0.91639859, 0.93893662, 0.         },
  { 0.94457324, 0.91077042, 0.         },
  { 0.9614831 , 0.87697606, 0.         },
  { 0.97839296, 0.84318169, 0.         },
  { 0.99530282, 0.80938732, 0.         },
  { 1.        , 0.76338028, 0.         },
  { 1.        , 0.71267606, 0.         },
  { 1.        , 0.66197183, 0.         },
  { 1.        , 0.61126761, 0.         },
  ...
  { 0.8178493 , 0.        , 0.         },
  { 0.80093944, 0.        , 0.         },
  { 0.84788732, 0.23943662, 0.23943662 },
  { 0.89859155, 0.49295775, 0.49295775 },
  { 0.94929577, 0.74647887, 0.74647887 },
  { 1.        , 1.        , 1.         }
};
  ...
  for (ci = FIRST_COLOR; ci <= LAST_COLOR; ci++)
    {
      ...
      switch (index)
        ...
        case COLORMAP_TEMPERATURE:
          j = inverted ? i - 1 : i;
          r = temperature[j][0] / 255.0;
          g = temperature[j][1] / 255.0;
          b = temperature[j][2] / 255.0;
          break;
