...
DLLEXPORT void gr_setproperty(char *string, ...);
DLLEXPORT void gr_beginproperty(char *string, ...);
DLLEXPORT void gr_addproperty(char *string, ...);
DLLEXPORT void gr_endproperty(void);
