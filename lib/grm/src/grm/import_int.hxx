...
inline std::unordered_map<int, std::string> elem_number_to_symbol = {
    ...
    {109, "Mt"}, {110, "Ds"}, {111, "Rg"}, {112, "Cn"}, {113, "Nh"}, {114, "Fl"}, {115, "Mc"}, {116, "Lv"}, {117, "Ts"},
    {118, "Og"},
};
...
grm_error_t readDataFile(const std::string &path, std::vector<std::vector<std::vector<std::vector<double>>>> &data,
                         ...
                         std::vector<std::vector<int>> &timestamps, std::vector<double *> special_data_grid);
