...
#define DLLEXPORT __declspec(dllexport)
  ...
  DLLEXPORT void gks_movplugin(int fctid, int dx, int dy, int dimx, int *i_arr, int len_f_arr_1, double *f_arr_1,
...
static void pdf_close(PDF *p)
{
  ...
  if (env != NULL) framerate = atoi(env);
...
static void open_ws(int fd, char *path, int wstype)
{
...
void gks_movplugin(int fctid, int dx, int dy, int dimx, int *ia, int lr1, double *r1, int lr2, double *r2, int lc,
                   char *chars, void **ptr)
{
  p = (ws_state_list *)*ptr;
...
void gks_movplugin(int fctid, int dx, int dy, int dimx, int *i_arr, int len_f_arr_1, double *f_arr_1, int len_f_arr_2,
