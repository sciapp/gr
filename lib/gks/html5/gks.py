...
fill_prototype = CFUNCTYPE(c_void_p, c_int, POINTER(c_double), POINTER(c_double), c_int)
line_prototype = CFUNCTYPE(c_void_p, c_int, POINTER(c_double), POINTER(c_double), c_int, c_int)
...
_gks.gks_set_dev_xform.argtypes = (POINTER(state_list), POINTER(c_double), POINTER(c_double))
def set_dev_xform(s_list, window, viewport):
    ...
    _gks.gks_set_dev_xform(s_list, cast(c_window,POINTER(c_double)), cast(c_viewport,POINTER(c_double)))
...
_gks.gks_inq_rgb.argtypes = (c_int, POINTER(c_double), POINTER(c_double), POINTER(c_double))
...
_gks.gks_emul_text.argtypes = (c_double, c_double, c_int, c_char_p, line_prototype, fill_prototype)
def emul_text(x_pos, y_pos, text):
    _gks.gks_emul_text(c_double(x_pos), c_double(y_pos), c_int(len(text)), c_char_p(text), line_callback, fill_callback)
    
_gks.gks_set_norm_xform.argtypes = (c_int, POINTER(c_double), POINTER(c_double))
def set_norm_xform(tnr, window, viewport):
    ...
    _gks.gks_set_norm_xform(c_int(tnr), cast(c_window,POINTER(c_double)), cast(c_viewport, POINTER(c_double)))
