...
extern void STDCALL GCA(float *, float *, float *, float *, int *, int *, int *, int *, int *, int *, int *);
...
extern void STDCALL GINLC(int *, int *, int *, float *, float *, int *, float *, float *, float *, float *, int *,
                          char *, unsigned short);
extern void STDCALL GRQLC(int *, int *, int *, int *, float *, float *);
extern void STDCALL GRQSK(int *, int *, int *, int *, int *, int *, float *, float *);
...
extern void STDCALL GEVTM(float *, float *, float *, float *, float *, float *, float *, int *, float[3][2]);
...
#if defined(_WIN32) && !defined(__GNUC__)
extern void STDCALL GQTXX(int *, float *, float *, char *, unsigned short, int *, float *, float *, float *, float *);
extern void STDCALL GQTXXS(int *, float *, float *, int *, char *, unsigned short, int *, float *, float *, float *,
                           float *);
#else
extern void STDCALL GQTXX(int *, float *, float *, char *, int *, float *, float *, float *, float *, unsigned short);
extern void STDCALL GQTXXS(int *, float *, float *, int *, char *, int *, float *, float *, float *, float *,
                           unsigned short);
#endif
extern void STDCALL GQDSP(int *, int *, int *, float *, float *ry, int *lx, int *ly);
