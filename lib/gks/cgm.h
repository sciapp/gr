...
#define max_long                                     \
  10240              /* longest partition of command \
                        data (even) */
...
static char *cgmt_delim[] = {"", "BegMF", "EndMF", "BegPic", "BegPicBody", "EndPic"};


/* metafile descriptors */

static char *cgmt_mfdesc[] = {"",           "MFVersion", "MFDesc",        "VDCType",      "IntegerPrec",  "RealPrec",
                              "IndexPrec",  "ColrPrec",  "ColrIndexPrec", "MaxColrIndex", "ColrValueExt", "MFElemList",
                              "MFDefaults", "FontList",  "CharSetList",   "CharCoding"};


/* page descriptors */

static char *cgmt_pdesc[] = {"",       "ScaleMode", "ColrMode", "LineWidthMode", "MarkerSizeMode", "EdgeWidthMode",
                             "VDCExt", "BackColr"};


/* control elements */

static char *cgmt_control[] = {"", "VDCIntegerPrec", "VDCRealPrec", "AuxColr", "Transparency", "ClipRect", "Clip"};


/* graphical primitives */

static char *cgmt_gprim[] = {"",          "Line",        "DisjtLine", "Marker",     "Text",
...
static char *cgmt_attr[] = {
    ...
    "MarkerType", "MarkerSize",   "MarkerColr",      "TextIndex",  "TextFontIndex", "TextPrec",
    "CharExpan",  "CharSpace",    "TextColr",        "CharHeight", "CharOri",       "TextPath",
    "TextAlign",  "CharSetIndex", "AltCharSetIndex", "FillIndex",  "IntStyle",      "FillColr",
    "HatchIndex", "PatIndex",     "EdgeIndex",       "EdgeType",   "EdgeWidth",     "EdgeColr",
    "EdgeVis",    "FillRefPt",    "PatTable",        "PatSize",    "ColrTable",     "ASF"};


/* escape element */

static char *cgmt_escape[] = {"", "Escape"};


/* external elements */

static char *cgmt_external[] = {"", "Message", "ApplData"};


static char **cgmt_cptr[8] = {cgmt_delim, cgmt_mfdesc, cgmt_pdesc,  cgmt_control,
                              cgmt_gprim, cgmt_attr,   cgmt_escape, cgmt_external};


/* used metafile elements */

static int element_list[n_melements * 2] = {0, (int)No_Op,
                                            0, (int)B_Mf,
                                            0, (int)E_Mf,
                                            0, (int)B_Pic,
                                            0, (int)B_Pic_Body,
